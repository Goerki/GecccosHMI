...
void MainWindow::startMainWindow(){
    ...
    project = new GecccosProject(folder,"C:/Users/TGyoergy/Desktop/TGyoergy/Privat/Uni/GECCCOS/GECCCOS_HMI/config.json",true);
...
void MainWindow::clearLayout(){
    ...
    if (this->poleDetailLayout->isVisible()){
...
void MainWindow::polePressed(const QModelIndex &index){
    ...
    if (selectedPole==nullptr){
        ...
        this->poleDetailLayout->showPole(selectedPole);
